...
async function getGroqResponse(value) {
    const promptValue = `Escreva um poema de 8 linhas sobre ${value} em Português do Brasil. Cada linha deve ter 4-5 palavras. Não adicione nada além do poema. Apenas o poema.`;
    const options = {
        method: 'POST',
        headers: {
